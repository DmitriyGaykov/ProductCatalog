...
namespace ProductCatalog.Data.Migrations
{
    ...
    [Migration("20250311213650_Users_ChangeField_Email_Optional")]
    partial class Users_ChangeField_Email_Optional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductCatalog.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("92253e45-44da-461c-a607-a7e32fb1fcc4"),
                            CreatedAt = new DateTime(2025, 3, 12, 0, 36, 50, 315, DateTimeKind.Local).AddTicks(9952),
                            Email = "admin@mail.by",
