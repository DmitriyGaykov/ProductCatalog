...
namespace ProductCatalog.Data.Migrations
{
    ...
    [Migration("20250311215916_Categories_FieldName_Unique")]
    partial class Categories_FieldName_Unique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductCatalog.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a9220cbe-2b78-4f58-9fcf-1fa5b41cd95e"),
                            CreatedAt = new DateTime(2025, 3, 12, 0, 59, 14, 379, DateTimeKind.Local).AddTicks(846),
                            Email = "admin@mail.by",
